...
export default function HomePage() {
  return (
    <main className="min-h-screen bg-white text-gray-900 font-sans">
      ...
      {/* Contact Section */}
      <section id="contact" className="bg-green-50 py-12 px-6 text-center">
        <div className="max-w-xl mx-auto">
          <h2 className="text-2xl font-semibold mb-4">Get Involved</h2>
          <p className="mb-6">
            Are you a land steward, town official, donor, or community healer?
            Let’s regenerate together.
          </p>
          <a
            href="mailto:hello@zentrust.world"
            className="inline-block px-6 py-3 bg-green-700 text-white rounded-2xl text-lg hover:bg-green-800 transition"
          >
            Email Us: hello@zentrust.world
          </a>
        </div>
      </section>
